...
return [
    ...
    'message' => [
        ...
        'maintenance' => [
            'html' => "<div style='margin: 100px; text-align: center; font-size: 50px; color:mediumvioletred'>Site is under maintenance. Please check back later.</div>",
            'view' => '' // Example: 'hashtagcms::fe.maintenance'
        ]
    ],
