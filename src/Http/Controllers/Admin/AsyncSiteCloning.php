...
use MarghoobSuleman\HashtagCms\Jobs\CloneSiteJob;
...
trait AsyncSiteCloning
{
    ...
    public function cloneSiteAsync($source_site_id = null, $target_site_id = null)
    {
        ...
        try {
            ...
            $dispatchResult = \MarghoobSuleman\HashtagCms\Queue\SmartJobDispatcher::dispatchSiteCloning(
                (int) $source_site_id,
                (int) $target_site_id,
                Auth::id(),
                $jobId
    ...
    public function getCloneStatus(string $jobId)
    {
        ...
        try {
            ...
            $status = \MarghoobSuleman\HashtagCms\Queue\SmartJobDispatcher::getJobStatus($jobId);
