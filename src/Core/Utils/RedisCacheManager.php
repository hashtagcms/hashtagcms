...
class RedisCacheManager
{
    ...
    /**
     * Get internal cache prefix
     * @return string
     */
    public static function getInternalPrefix(): string
    {
        return config('hashtagcms.internal_cache_prefix', 'internal_');
    }

    /**
     * Get database cache prefix
     * @return string
     */
    public static function getDatabasePrefix(): string
    {
        return config('hashtagcms.database_cache_prefix', 'db_');
    }

    /**
     * Get external source cache prefix
     * @return string
     */
    public static function getExternalSourcePrefix(): string
    {
        return config('hashtagcms.external_source_cache_prefix', 'ex_');
    }
}
