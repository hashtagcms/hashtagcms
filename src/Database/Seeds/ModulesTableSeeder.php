    ...
    public function run()
    {
        ...
        $modules = array(
            array(
                ...
                'query_as' => NULL,
                'data_handler' => 'select c.id, c.parent_id, c.is_new, c.has_wap, c.wap_url, c.link_rewrite, c.link_navigation,
...
order by cs.position asc',
                'data_key_map' => 'site_id,lang_id,platform_id',
                'description' => NULL,
                'is_mandatory' => '0',
                'method_type' => NULL,
                'service_params' => NULL,
...
and (p.expire_at IS NULL OR p.expire_at >= NOW())',
            ...
            array('id'=>'16', 'site_id'=>'1', 'name'=>'Example Static Module', 'alias'=>'MODULE_EXAMPLE_STATIC', 'linked_module'=>'0', 'view_name'=>'no-view-needed', 'data_type'=>'Static', 'query_statement'=>NULL, 'query_as'=>NULL, 'data_handler'=>'CONTENT_STATIC', 'data_key_map'=>NULL, 'description'=>NULL, 'is_mandatory'=>'0', 'method_type'=>NULL, 'service_params'=>NULL, 'individual_cache'=>'0', 'cache_group'=>NULL, 'is_seo_module'=>'0', 'live_edit'=>'0', 'shared'=>'0', 'created_at'=>$date, 'updated_at'=>$date, 'deleted_at'=>NULL),
            ...
            array(
                ...
                'site_id' => '1',
                'name' => 'Stories',
                'alias' => 'MODULE_STORIES',
                'linked_module' => '0',
                'view_name' => 'stories',
                'data_type' => 'Query',
                'query_statement' => NULL,
                'query_as' => NULL,
                'data_handler' => 'select c.link_rewrite as category_link_rewrite, u.name as user_name, p.read_count,
...
order by p.created_at DESC limit 10;',
            ...
            array('id' => '25', 'site_id' => '1', 'name' => 'Example UrlService', 'alias' => 'MODULE_EXAMPLE_URLSERVICE', 'linked_module' => '0', 'view_name' => 'example/urlservice', 'data_type' => 'UrlService', 'query_statement' => NULL, 'query_as' => NULL, 'data_handler' => 'https://picsum.photos/v2/list?page=2&limit=:limit', 'data_key_map' => 'limit', 'description' => NULL, 'is_mandatory' => '0', 'method_type' => 'GET', 'service_params' => NULL, 'individual_cache' => '0', 'cache_group' => NULL, 'is_seo_module' => '0', 'live_edit' => '0', 'shared' => '0', 'created_at' => NULL, 'updated_at' => $date, 'deleted_at' => NULL),
            array(
                'id' => '26',
                'site_id' => '1',
                'name' => 'Story Comments',
                'alias' => 'MODULE_STORY_COMMENTS',
                'linked_module' => '0',
                'view_name' => 'story-comments',
                'data_type' => 'Query',
                'query_statement' => NULL,
                'query_as' => NULL,
                'data_handler' => 'select name, email, comment, category_id, page_id, created_at from comments
where
page_id=(select id from pages where link_rewrite=:link_rewrite) and category_id=:category_id
and site_id=:site_id and deleted_at is null order by id desc;',
                'data_key_map' => 'link_rewrite,site_id,category_id',
                'description' => NULL,
                'is_mandatory' => '0',
                'method_type' => NULL,
                'service_params' => NULL,
            ...
            array('id' => 27, 'site_id' => 1, 'name' => 'Service Later', 'alias' => 'MODULE_SERVICE_LATER', 'linked_module' => 0, 'view_name' => 'example/service-later', 'data_type' => 'ServiceLater', 'query_statement' => NULL, 'query_as' => NULL, 'data_handler' => 'https://picsum.photos/v2/list?page=2&limit=5', 'data_key_map' => NULL, 'description' => NULL, 'is_mandatory' => 0, 'method_type' => NULL, 'service_params' => NULL, 'individual_cache' => 0, 'cache_group' => NULL, 'is_seo_module' => 0, 'live_edit' => 0, 'shared' => 0, 'created_at' => $date, 'updated_at' => $date, 'deleted_at' => NULL)
    ...
    private function moduleSiteSeed()
    {
        ...
        $module_site = array(
            ...
            array('site_id' => '1', 'microsite_id' => '0', 'platform_id' => '1', 'category_id' => '6', 'hook_id' => '10', 'module_id' => '27', 'position' => '7', 'publish_status' => '1', 'insert_by' => '1', 'update_by' => '1', 'approved_by' => '1', 'created_at' => $date, 'updated_at' => $date, 'deleted_at' => NULL),
