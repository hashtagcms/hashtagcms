...
class CmsModulesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cms_modules = array(
            ...
            //Added Module Types' in v3.0.0
            //'11', 'Module Types', 'moduletype', 'Frontend Module Type', NULL, '5', 'fa fa-cube', NULL, NULL, NULL, '4', '2026-03-07 09:17:56', '2026-03-07 09:35:17', NULL

            array('id' => '11', 'name' => 'Module Types', 'controller_name' => 'moduletype', 'display_name' => NULL, 'parent_id' => '5', 'sub_title' => 'Frontend Module Types', 'icon_css' => 'fa fa-cube', 'list_view_name' => NULL, 'edit_view_name' => NULL, 'position' => '4', 'created_at' => $date, 'updated_at' => $date, 'deleted_at' => NULL),            
            ...
            array('id' => '17', 'name' => 'Frontend Modules', 'controller_name' => 'module', 'display_name' => NULL, 'parent_id' => '13', 'sub_title' => 'Manage frontend modules', 'icon_css' => 'fa fa-puzzle-piece', 'list_view_name' => NULL, 'edit_view_name' => NULL, 'position' => '14', 'created_at' => NULL, 'updated_at' => $date, 'deleted_at' => NULL),
            ...
            array('id' => '20', 'name' => 'Festivals', 'controller_name' => 'festival', 'display_name' => NULL, 'parent_id' => '0', 'sub_title' => 'Manage Festivals', 'icon_css' => 'fa fa-snowflake-o', 'list_view_name' => NULL, 'edit_view_name' => NULL, 'position' => '24', 'created_at' => $date, 'updated_at' => $date, 'deleted_at' => NULL),
            ...
            array('id' => '39', 'name' => 'Galleries', 'controller_name' => 'gallery', 'display_name' => NULL, 'parent_id' => '0', 'sub_title' => 'Manage gallery and files', 'icon_css' => 'fa fa-picture-o', 'list_view_name' => NULL, 'edit_view_name' => NULL, 'position' => '25', 'created_at' => $date, 'updated_at' => $date, 'deleted_at' => NULL),
            ...
            //more module space for future use
