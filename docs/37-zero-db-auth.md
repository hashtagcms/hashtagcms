...
HASHTAGCMS_CONFIG_API=http://api.yoursite.com/api/hashtagcms/public/configs/v1/site-configs
HASHTAGCMS_DATA_API=http://api.yoursite.com/api/hashtagcms/public/sites/v1/load-data
HASHTAGCMS_LOGIN_API=http://api.yoursite.com/api/hashtagcms/public/user/v1/login
HASHTAGCMS_LOGOUT_API=http://api.yoursite.com/api/hashtagcms/public/user/v1/logout
```
