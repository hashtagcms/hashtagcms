...
HASHTAG_CMS_CONFIG_API=https://api.yoursite.com/api/hashtagcms/public/configs/v1/site-configs
HASHTAG_CMS_DATA_API=https://api.yoursite.com/api/hashtagcms/public/sites/v1/load-data
```
