...
HASHTAGCMS_EXTERNAL_API_BASE_URL=http://your-api-domain.com

# Specific Endpoint Overrides (Optional)
HASHTAGCMS_DATA_API=                   # Default: {BASE}/api/hashtagcms/public/sites/v1/load-data
HASHTAGCMS_LOGIN_API=                  # Default: {BASE}/api/hashtagcms/public/sites/v1/login
HASHTAGCMS_LOGOUT_API=                 # Default: {BASE}/api/hashtagcms/public/user/v1/logout
HASHTAGCMS_USER_ME_API=                # Default: {BASE}/api/hashtagcms/user/v1/me
HASHTAGCMS_USER_PROFILE_UPDATE_API=    # Default: {BASE}/api/hashtagcms/user/v1/profile
HASHTAGCMS_PUBLISH_API=                # Default: {BASE}/api/hashtagcms/public/kpi/v1/publish
```
