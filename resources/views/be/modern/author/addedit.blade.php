    ...
    <div
        ...
        <form action="{{htcms_get_save_path(request()->module_info->controller_name)}}" method="post"
            ...
            <div class="p-8 lg:p-10 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div id="rolePermissionsPreview" class="mt-3 hidden">
                        <div class="rounded-xl border border-indigo-100 bg-indigo-50/40 p-4 space-y-3">
                            ...
                            <div id="roleSuperAdminBadge"
                                class="hidden flex items-center gap-2 px-3 py-2 rounded-lg bg-amber-50 border border-amber-200">
                                <i class="fa fa-star text-amber-500 text-xs"></i>
                                <div>
                                    <p class="text-[10px] font-black uppercase tracking-widest text-amber-600">Super Admin —
                                        Unrestricted Access</p>
                                    <p class="text-[10px] text-amber-500">All permissions on all sites are granted
                                        automatically. No site assignment needed.</p>
                                </div>
                            </div>
                ...
                <div id="sitesAutoNotice"
                    class="hidden rounded-xl border border-emerald-100 bg-emerald-50 p-4 flex items-start gap-3">
                    <i class="fa fa-check-circle text-emerald-500 mt-0.5"></i>
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-emerald-600">All Sites — Access
                            Automatic</p>
                        <p class="text-[10px] text-emerald-500 mt-0.5">Super Admin role has access to all sites
                            automatically. No manual site assignment is required.</p>
                    </div>
                </div>
...
@push('scripts')
    <script>
        var __rolePermissionsMap = @json(json_decode($rolePermissionsMap ?? '{}'));
