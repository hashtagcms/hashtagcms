...
@section('content')
    ...
    <div
        class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden max-w-5xl mx-auto">
        <!-- Card Header -->
        <div class="px-8 py-6 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
            ...
            <span
                class="text-[10px] font-black uppercase text-blue-600 bg-blue-50 px-3 py-1 rounded-full">{{ $content_type }}
                Page</span>
        </div>
        ...
        <form action="{{htcms_get_save_path(request()->module_info->controller_name)}}" method="post"
            ...
            <div class="p-8 lg:p-12 space-y-16">
                ...
                <section data-collapsible="page-core-identity" data-collapsed="false"
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-[10px] text-slate-500 mt-2 leading-relaxed">
                                    ...
                                    Only categories with <code
                                        class="font-mono bg-slate-100 text-pink-500 px-1.5 py-0.5 rounded text-[9px]">{link_rewrite}</code>
                                    or <code
                                        class="font-mono bg-slate-100 text-pink-500 px-1.5 py-0.5 rounded text-[9px]">{link_rewrite?}</code>
                                    patterns are available here. Your page URL will be structured as: <code
                                        class="font-mono bg-slate-100 text-blue-500 px-1.5 py-0.5 rounded text-[9px]">{category_link_rewrite}/{this_page_link_rewrite}</code>.
                                </p>
                            </div>
                ...
                <section data-collapsible="page-rich-content" data-collapsed="false"
                    class="rounded-2xl border border-slate-100 overflow-hidden">
                    <div data-collapsible-trigger
                        class="flex items-center gap-4 px-6 py-4 bg-slate-50/60 hover:bg-slate-100/60 cursor-pointer select-none transition-colors">
                        <div
                        ...
                        <h4 class="text-[10px] font-black uppercase tracking-widest text-slate-700 flex-1">Rich Content
                            &amp; Media</h4>
                        <i data-collapsible-chevron
                            class="fa fa-chevron-down text-slate-400 text-xs transition-transform duration-300"></i>
                    </div>
                    <div data-collapsible-body style="transition: max-height 0.35s ease, overflow 0s 0.35s;">
                        <div class="p-6 space-y-8">
                            ...
                            <div class="pt-6 border-t border-slate-100 space-y-6">
                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 block">Media
                                    Assets</span>
                                <div class="space-y-6">
                                    <div class="space-y-4">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div
                                            class="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-4 overflow-hidden">
                                            {!! FormHelper::file('img', $img, array('accept' => 'image/*'), TRUE, 100) !!}
                                            <div
                                                class="relative py-2 text-center text-[10px] text-slate-400 uppercase font-black tracking-[0.2em]">
                                                -- OR RELATIVE PATH --</div>
                ...
                <section data-collapsible="page-seo" data-collapsed="false"
                    ...
                    <div data-collapsible-trigger
                        ...
                        <h4 class="text-[10px] font-black uppercase tracking-widest text-slate-700 flex-1">SEO &
                            Configuration</h4>
                        <i data-collapsible-chevron
                            class="fa fa-chevron-down text-slate-400 text-xs transition-transform duration-300"></i>
                    </div>
                    <div data-collapsible-body style="transition: max-height 0.35s ease, overflow 0s 0.35s;">
                        <div class="p-6 space-y-6">
                            ...
                            <div class="pt-6 border-t border-slate-100 space-y-6">
                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 block">Code
                                    Injections</span>
                                <div class="space-y-6">
                                    <div class="space-y-2">
                ...
                <section data-collapsible="page-governance" data-collapsed="false"
                    class="rounded-2xl border border-slate-100 overflow-hidden">
                    <div data-collapsible-trigger
                        class="flex items-center gap-4 px-6 py-4 bg-slate-50/60 hover:bg-slate-100/60 cursor-pointer select-none transition-colors">
                        <div
